<?php
class MageCoders_ShippingDiscount_Block_Adminhtml_Edit_Tab_Actions  extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions{
	...
	protected function _prepareForm()
    {
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'name'      => 'simple_action',
            'options'    => Mage::getSingleton('shippingdiscount/actions')->toOptionArray()
        ));
