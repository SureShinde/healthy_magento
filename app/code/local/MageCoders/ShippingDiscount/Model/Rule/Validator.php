<?php 
class MageCoders_ShippingDiscount_Model_Rule_Validator extends Mage_SalesRule_Model_Validator{
 /**
    ...
    public function process(Mage_Sales_Model_Quote_Item_Abstract $item)
    {
        ...
        foreach ($this->_getRules() as $rule) {
			...
			if(!Mage::helper('shippingdiscount')->isShipAction($rule->getSimpleAction())){
