	...
	class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
	{
		...
		public function forgotPasswordPostAction()
		{
			...
			if ($email) {
				...
				// checking to see if this email exists already, if it does we will notify that an email has been sent with link
				// if not we will notify that they need to create new account
				...
				if(in_array($email, $customerEmail)){
					$this->_getSession()
						->addSuccess(Mage::helper('adminhtml')->__('An email was sent to %s with a link to reset your password.', Mage::helper('adminhtml')->escapeHtml($email)));
				} else {
					$this->_getSession()
						->addError(Mage::helper('adminhtml')->__('The email address %s was not found. For security purposes, please create a new account. If you need assistance with this, please call 800.521.9054 for assistance.', Mage::helper('adminhtml')->escapeHtml($email)));
				}
				//            $this->_getSession()
