...
class Mage_Core_Block_Html_Date extends Mage_Core_Block_Template
{
    ...
    protected function _toHtml()
    {
        ...
        //SET START INITIAL DATE FOR HACKLEY KITS KIT START DATE
        $html .= 'value="' . date("m/d/Y g:i A", mktime(8, 0, 0, date("m"), date("d")+2,   date("Y"))) . '" class="' . $this->getClass() . '" ' . $this->getExtraParams() . '/> ';
