...
class Mage_Reports_Model_Resource_Customer_Collection extends Mage_Customer_Model_Resource_Customer_Collection
{
    ...
    {
        $this->getSelect()
            ->columns(array("orders_count" => "orders.entity_id"))
            ->where('orders.status = ?', Mage_Sales_Model_Order::STATUS_COMPLETE)
            ->group("e.entity_id");
    ...
    public function addSumAvgTotals($storeId = 0)
    {
        ...
        $this->getSelect()
			->columns(array("order_id" => "increment_id"))
    ...
    public function getSelectCountSql()
    {
        ...
        $countSelect->columns("DISTINCT e.entity_id");
