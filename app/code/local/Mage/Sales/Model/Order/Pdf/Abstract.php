...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($order->getIsVirtual()) {
            ...
            $yShipments = $this->y;
            $totalShippingChargesText = "(" . Mage::helper('sales')->__('Total Shipping Charge') . " "
                . $order->formatPriceTxt($order->getShippingAmount()) . ")". $order->getMessage();
				

            $page->drawText($totalShippingChargesText, 285, $yShipments - $topMargin, 'UTF-8');
            $yShipments -= $topMargin + 10;
			
			// Adding the shipping notes to the Print Orders PDF
			// $shippingNotesText = "Shipping Notes: " . $order->getShippingAddress();
			// $page->drawText($shippingNotesText, 285, $yShipments - $topMargin, 'UTF-8');
