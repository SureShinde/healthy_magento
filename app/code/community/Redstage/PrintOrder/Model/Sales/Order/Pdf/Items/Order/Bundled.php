 ...
 */
class Redstage_PrintOrder_Model_Sales_Order_Pdf_Items_Order_Bundled extends Mage_Bundle_Model_Sales_Order_Pdf_Items_Abstract
{
    public function getChilds($item)
    {
        ...
        if ($_items) {
            foreach ($_items as $_item) {
                ...
                if ($parentItem) {
                    $_itemsArray[$parentItem->getId()][$_item->getItemId()] = $_item;
                } else {
                    $_itemsArray[$_item->getId()][$_item->getItemId()] = $_item;
                }
            }
        }
