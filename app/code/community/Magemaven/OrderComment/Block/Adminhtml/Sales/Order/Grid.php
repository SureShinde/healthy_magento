 ...
 */
class Magemaven_OrderComment_Block_Adminhtml_Sales_Order_Grid extends Inchoo_EnhancedExport_Block_Mage_Adminhtml_Sales_Order_Grid
{
    /**
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('ordercomment', array(
            'header'       => Mage::helper('ordercomment')->__('Order Comment(s)'),
            'index'        => 'ordercomment'
        ));
