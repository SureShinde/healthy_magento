...
class Mage_Adminhtml_Sales_Order_ShipmentController extends Mage_Adminhtml_Controller_Sales_Shipment
{
 ...
 //echo 'SELECT `quote_item_id` FROM `sales_flat_order_item` WHERE order_id =  '.$this->getRequest()->getParam('order_id');exit;

 $getQuoteId = $readConnection->fetchOne('SELECT `quote_item_id` FROM `sales_flat_order_item` WHERE order_id = ' .$this->getRequest()->getParam('order_id'));
          //echo 'capital'.$getQuoteId;
$getOrderProductInfo = $readConnection->fetchAll('SELECT * FROM `sales_flat_quote_item` WHERE `item_id` = ' .$getQuoteId);

   $getOrderProductInfoOptions = $readConnection->fetchOne('SELECT `product_options` FROM `sales_flat_order_item` WHERE `order_id` = '  .$this->getRequest()->getParam('order_id'));
  ...
  echo $query = "INSERT INTO `custom_sales_flat_quote_item` (`item_id`, `quote_id`, `created_at`, `updated_at`, `product_id`, `subscribed_prod_id`, `store_id`, `parent_item_id`, `is_virtual`, `sku`, `name`, `description`, `applied_rule_ids`, `additional_data`, `free_shipping`, `is_qty_decimal`, `no_discount`, `weight`, `qty`, `price`, `base_price`, `custom_price`, `discount_percent`, `discount_amount`, `base_discount_amount`, `tax_percent`, `tax_amount`, `base_tax_amount`, `row_total`, `base_row_total`, `row_total_with_discount`, `row_weight`, `product_type`, `base_tax_before_discount`, `tax_before_discount`, `original_custom_price`, `redirect_url`, `base_cost`, `price_incl_tax`, `base_price_incl_tax`, `row_total_incl_tax`, `base_row_total_incl_tax`, `hidden_tax_amount`, `base_hidden_tax_amount`, `gift_message_id`, `weee_tax_disposition`, `weee_tax_row_disposition`, `base_weee_tax_disposition`, `base_weee_tax_row_disposition`, `weee_tax_applied`, `weee_tax_applied_amount`, `weee_tax_applied_row_amount`, `base_weee_tax_applied_amount`, `base_weee_tax_applied_row_amnt`, `variety_entrees`, `subscribed_variety_entree`, `hmr_120_choco`, `subscribed_hmr_120_choco`, `hmr_120_vani`, `subscribed_hmr_120_vani`, `hrm_70_choco`, `subscribed_hmr_70_choco`, `hmr_70_vani`, `subscribed_hmr_70_vani`)
VALUES ('".$getOrderProductInfo[0]['item_id']."', '".$getOrderProductInfo[0]['quote_id']."', '".$getOrderProductInfo[0]['created_at']."', '".$getOrderProductInfo[0]['updated_at']."', '".$getOrderProductInfo[0]['product_id']."', '".$getOrderProductInfo[0]['subscribed_prod_id']."', '".$getOrderProductInfo[0]['store_id']."', '".$getOrderProductInfo[0]['parent_item_id']."', '".$getOrderProductInfo[0]['is_virtual']."', '".$getOrderProductInfo[0]['sku']."', '".$getOrderProductInfo[0]['name']."', '".$getOrderProductInfo[0]['description']."', '".$getOrderProductInfo[0]['applied_rule_ids']."', '".$getOrderProductInfo[0]['additional_data']."','".$getOrderProductInfo[0]['free_shipping']."', '".$getOrderProductInfo[0]['is_qty_decimal']."', '".$getOrderProductInfo[0]['no_discount']."', '".$getOrderProductInfo[0]['weight']."', '".$getOrderProductInfo[0]['qty']."', '".$getOrderProductInfo[0]['price']."', '".$getOrderProductInfo[0]['base_price']."', '".$getOrderProductInfo[0]['custom_price']."', '".$getOrderProductInfo[0]['discount_percent']."', '".$getOrderProductInfo[0]['discount_amount']."', '".$getOrderProductInfo[0]['base_discount_amount']."', '".$getOrderProductInfo[0]['tax_percent']."', '".$getOrderProductInfo[0]['tax_amount']."','".$getOrderProductInfo[0]['base_tax_amount']."', '".$getOrderProductInfo[0]['row_total']."', '".$getOrderProductInfo[0]['base_row_total']."', '".$getOrderProductInfo[0]['row_total_with_discount']."', '".$getOrderProductInfo[0]['row_weight']."', '".$getOrderProductInfo[0]['product_type']."', '".$getOrderProductInfo[0]['base_tax_before_discount']."', '".$getOrderProductInfo[0]['tax_before_discount']."', '".$getOrderProductInfo[0]['original_custom_price']."', '".$getOrderProductInfo[0]['redirect_url']."', '".$getOrderProductInfo[0]['base_cost']."', '".$getOrderProductInfo[0]['price_incl_tax']."', '".$getOrderProductInfo[0]['base_price_incl_tax']."', '".$getOrderProductInfo[0]['row_total_incl_tax']."', '".$getOrderProductInfo[0]['base_row_total_incl_tax']."', '".$getOrderProductInfo[0]['hidden_tax_amount']."', '".$getOrderProductInfo[0]['base_hidden_tax_amount']."', '".$getOrderProductInfo[0]['gift_message_id']."', '".$getOrderProductInfo[0]['weee_tax_disposition']."', '".$getOrderProductInfo[0]['weee_tax_row_disposition']."', '".$getOrderProductInfo[0]['base_weee_tax_disposition']."','".$getOrderProductInfo[0]['base_weee_tax_row_disposition']."', '".$getOrderProductInfo[0]['weee_tax_applied']."', '".$getOrderProductInfo[0]['weee_tax_applied_amount']."', '".$getOrderProductInfo[0]['weee_tax_applied_row_amount']."', '".$getOrderProductInfo[0]['base_weee_tax_applied_amount']."', '".$getOrderProductInfo[0]['base_weee_tax_applied_row_amnt']."', '".$additionalOptions."','', '".$getOrderProductInfo[0]['hmr_120_choco']."', '".$getOrderProductInfo[0]['subscribed_hmr_120_choco']."', '".$getOrderProductInfo[0]['hmr_120_vani']."', '".$getOrderProductInfo[0]['subscribed_hmr_120_vani']."', '".$getOrderProductInfo[0]['hrm_70_choco']."', '".$getOrderProductInfo[0]['subscribed_hmr_70_choco']."','".$getOrderProductInfo[0]['hmr_70_vani']."', '".$getOrderProductInfo[0]['subscribed_hmr_70_vani']."')";
